...
public class UI_Over_3D : MonoBehaviour {
  ...
  void Update() {
    ...
    // 0,0 for the canvas is at the center of the screen, whereas WorldToViewPortPoint treats the
    // lower left corner as 0,0. Because of this, you need to subtract the height / width of the
    // canvas * 0.5 to get the correct position.
    ...
    if (scaleWithDistance) {
      float distance =
          Vector3.Dot(worldPos - Camera.main.transform.position, Camera.main.transform.forward);
